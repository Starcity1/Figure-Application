"""
-- THIS SCRIPT HAS BEEN MODIFIED BY DAVID RODRIGUEZ. PLEASE READ BELOW TO UNDERSTAND THE CHANGES--

This new version creates and return a dictionary structure containing all of the data in the form
...
This new version is used primarily for the implementation of chargepol.
...
def write_output(filename_output, pos_time, pos_zmin, pos_zwid, pos_flax, pos_flay, neg_time, neg_zmin, neg_zwid, neg_flax, neg_flay) -> dict:
